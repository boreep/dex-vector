...
def start_retargeting(queue: multiprocessing.Queue, robot_dir: str, config_path: str):
    ...
    retargeting = RetargetingConfig.load_from_file(config_path).build()#是一个SeqRetargeting类型，包含算法和机器人映射的具体实现。
    ...
    if "ability" in robot_name:
        ...
        loader.scale = 1.5
    elif "inspire" in robot_name or "roh"in robot_name:
        loader.scale = 1.15

    if "inspire" in robot_name or "roh"  in robot_name:
    ...
    # print("#################################################")
    # print("retargeting_joint_names",retargeting_joint_names)
    # print("#################################################")
    # print("retargeting_to_sapien",retargeting_to_sapien)
    # print("#################################################")
...
#获取视频得到数据
    while True:
        ...
        _, joint_pos, keypoint_2d, keypoint_3d, _ = detector.detect(rgb)
...
def main(
    robot_name: RobotName, retargeting_type: RetargetingType, hand_type: HandType, camera_path: Optional[str] = 6
):
    """
