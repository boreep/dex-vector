...
class Mimic:
    ...
    multiplier1: Optional[float] = None
    multiplier2: Optional[float] = None
    multiplier3: Optional[float] = None
...
class URDF:
    ...
    def _parse_mimic(xml_element):
        ...
        return Mimic(
            ...
            multiplier1=_str2float(xml_element.get("multiplier1", 0.0)),
            multiplier2=_str2float(xml_element.get("multiplier2", 0.0)),
            multiplier3=_str2float(xml_element.get("multiplier3", 0.0)),
        )
